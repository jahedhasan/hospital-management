...
if(strlen($_SESSION['id']==0)) {
	...
	{	
		...
		$doctorprofileinfo=$_POST['doctorprofileinfo'];
		...
		$sql=mysqli_query($con,"insert into doctors(specilization,doctorName,doctorprofileinfo,practiceDays,docFees,contactno,docEmail,password,img) values('$docspecialization','$docname','$doctorprofileinfo','$practiceDays','$docfees','$doccontactno','$docemail','$password','$location')");
		if($sql)
		{
												...
												<div class="panel-body">
													...
													<form role="form" name="adddoc" method="post" onSubmit="return valid();" enctype = "multipart/form-data">
														...
														<div class="form-group">
															...
															<textarea name="doctorprofileinfo" class="form-control"  placeholder="Enter Doctor Profile Information In Details" required="true"></textarea>
														</div>
														...
														<div class="form-group">
															...
															<textarea name="practiceDays" class="form-control"  placeholder="Enter Practice Day with comma separator" required="true"></textarea>
														</div>
