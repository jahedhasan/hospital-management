...
if(strlen($_SESSION['id']==0) || $_SESSION['role'] != 'admin') {
	...
	{	
		...
		$sql=mysqli_query($con,"insert into doctors(specilization,doctorName,doctorprofileinfo,practiceDays,img) values('$docspecialization','$docname','$doctorprofileinfo','$practiceDays','$location')");
		if($sql)
		{
