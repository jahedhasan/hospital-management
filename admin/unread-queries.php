...
<html lang="en">
	<head>
		<title><?php if($userRole == 'admin'){ echo "Admin";} else { echo "Staff";} ?> | Manage Unread Queries</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><?php if($userRole == 'admin'){ echo "Admin";} else { echo "Staff";} ?> | Manage Unread Queries</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th >Doctor Name</th>
												<th class="hidden-xs">Specialization</th>
												<th>Patient Name</th>
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from tblappointment where IsRead is null");
$cnt=1;
