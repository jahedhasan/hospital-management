...
<head>
	...
	<script type="text/javascript">
		function valid() {
			var cpass = document.chngpwd.cpass.value;
			var npass = document.chngpwd.npass.value;
			var cfpass = document.chngpwd.cfpass.value;
			...
			if (cpass == "") {
				...
				return false;
			} else if (!passwordRegex.test(npass)) {
								...
								<div class="col-lg-8 col-md-12">
									<div class="panel panel-white">
										...
										<div class="panel-body">
											<p style="color:red">Password must be at least 8 characters long, include an uppercase letter, a lowercase letter, a number, and a special character.</p>
