...
//updating Admin Remark
	if(isset($_POST['update']))
	{
		...
		$isread=1;
		$query=mysqli_query($con,"update tblappointment set  AdminRemark='$adminremark',IsRead='$isread' where id='$qid'");
		if($query){
	...
	<html lang="en">
	<head>
		<title><?php if($userRole == 'admin'){ echo "Admin";} else { echo "Staff";} ?> | Query Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><?php if($userRole == 'admin'){ echo "Admin";} else { echo "Staff";} ?> | Query Details</h1>
								</div>
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
											<?php
											$qid=intval($_GET['id']);
											$sql=mysqli_query($con,"select * from tblappointment where id='$qid'");
											$cnt=1;
