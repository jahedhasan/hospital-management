...
//Code for Update the Content
	...
	if(isset($_POST['submit']))
	{
		...
		$notice=$_POST['notice'];
		$query=mysqli_query($con,"update notice set notice='$notice'");
		if ($query) {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Update the Notice</h1>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<form class="forms-sample" method="post">
										...
										$row=mysqli_fetch_array($ret) ;
											...
											<div class="form-group">
												...
												<textarea class="form-control" name="notice" id="notice" rows="5"><?php  echo $row['notice'];?></textarea>
											</div>
